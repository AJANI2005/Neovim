return {
  {
    ...
    config = function()
      ...
      -- Keymaps
      vim.keymap.set("n", "<leader>dt", dap.toggle_breakpoint, { desc = "Toggle Breakpoint", nowait = true, remap = false })
      ...
      vim.keymap.set("n", "<leader>dr", function() dap.repl.open() end, { desc = "Open REPL", nowait = true, remap = false })
      vim.keymap.set("n", "<leader>dl", dap.run_last, { desc = "Run Last", nowait = true, remap = false })
      vim.keymap.set(
        "n",
        "<leader>db",
        function() print(vim.inspect(dap.list_breakpoints())) end,
        { desc = "List Breakpoints", nowait = true, remap = false }
      )
      vim.keymap.set(
        "n",
        "<leader>de",
        function() dap.set_exception_breakpoints({ "all" }) end,
        { desc = "Set Exception Breakpoints", nowait = true, remap = false }
      )
